<?php
    ...
    if(mysqli_num_rows($result) == 0){
        ...
        foreach ($rows as $key => $value) {
            $layout .= "<div><div class='card' style='width: 18rem;  height: 50rem;'>
    ...
    <a href='publisher.php?publisher={$value["publisher_name"]}' class='btn btn-outline-danger btn-sm my-1'>{$value["publisher_name"]}</a>
